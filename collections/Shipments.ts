  ...
  fields: [
    {
      ...
      admin: {
        position: "sidebar",
        readOnly: true,
        description: "Auto-generated, human-readable identifier (e.g. PH-2026-000001).",
      },
      validate: (value?: string | null) => {
        if (!value) return true;
        return /^(SC|PH)-\d{4}-\d{6,}$/.test(value)
          ? true
          : "Tracking number must follow the format PH-YYYY-###### (legacy SC-YYYY-###### accepted).";
      },
    },
    {
      name: "sender",
