...
const email = smtpConfigured
  ? nodemailerAdapter({
      defaultFromAddress: process.env.SMTP_FROM_ADDRESS || "noreply@primehublogistics.com",
      defaultFromName: process.env.SMTP_FROM_NAME || "PrimeHub Logistics",
      transportOptions: {
...
export default buildConfig({
  admin: {
    user: Users.slug,
    meta: {
      titleSuffix: " - PrimeHub Logistics Admin",
      description: "PrimeHub Logistics business management platform.",
    },
    components: {
      graphics: {
