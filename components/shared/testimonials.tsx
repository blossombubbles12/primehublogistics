...
const testimonials = [
  {
    quote: "PrimeHub Logistics transformed how we handle deliveries for our Shopify store. What used to take hours of manual work now happens automatically. Our customers love the real-time tracking.",
  ...
  {
    quote: "We needed to ship medical supplies to clinics across the Netherlands and the UK with temperature monitoring. PrimeHub Logistics' cold chain solution and dedicated support made it seamless.",
    ...
    <Section background="white" spacing="lg" pattern="dots">
      <Reveal>
        <SectionHeading
          ...
          description="From solo entrepreneurs to enterprise teams. See why businesses across the Netherlands and the UK trust PrimeHub Logistics with their deliveries."
        />
      </Reveal>
