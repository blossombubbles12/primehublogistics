...
export const metadata: Metadata = {
  title: "Track Order | PrimeHub Logistics",
  description:
    "Track the status of your PrimeHub Logistics delivery. Enter your order number to see the latest updates.",
};

const helpChannels = [
  { icon: Phone, title: "Call Us", value: "+31 20 000 0000" },
  { icon: Mail, title: "Email Us", value: "hello@primehublogistics.com" },
  ...
  return (
    <>
      <SubpageHero
        ...
        description="Enter your order number below to trace the status of your PrimeHub Logistics delivery."
      />
