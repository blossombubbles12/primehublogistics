...
export const metadata: Metadata = {
  title: "Ship a Package | PrimeHub Logistics",
  description: "Book a shipment with PrimeHub Logistics. Enter your details, get an instant quote, and schedule pickup across the Netherlands and the UK.",
  openGraph: {
    title: "Ship a Package | PrimeHub Logistics",
