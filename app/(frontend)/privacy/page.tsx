...
export const metadata: Metadata = {
  title: "Privacy Policy | PrimeHub Logistics",
  description: "Read the PrimeHub Logistics privacy policy to understand how we collect, use, and protect your personal and shipment data.",
  openGraph: {
    title: "Privacy Policy | PrimeHub Logistics",
    description: "Your privacy matters. This policy explains how PrimeHub Logistics collects, uses, and protects your information.",
    type: "website",
  },
};
...
export default function PrivacyPolicyPage() {
  return (
    <PolicyPage
      ...
      description="Your privacy matters to us. This policy explains how PrimeHub Logistics collects, uses, and protects your personal and shipment data."
      ...
      sections={[
        ...
        },
        {
          ...
          items: [
            ...
            "To exercise rights: email privacy@primehublogistics.com or use account settings",
          ],
        },
        {
        ...
        },
        {
          ...
          items: [
            "Email: privacy@primehublogistics.com",
