...
export const metadata: Metadata = {  title: "Help Center | PrimeHub Logistics",
  description: "Guides and answers for shipping, tracking, billing and returns with PrimeHub Logistics. Find help fast or talk to our support team.",
  openGraph: {
    title: "Help Center | PrimeHub Logistics",
