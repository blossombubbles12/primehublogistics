...
export const metadata: Metadata = {
  title: "Coverage | PrimeHub Logistics",
  description: "Check PrimeHub Logistics delivery coverage across the Netherlands and the United Kingdom. 500+ cities and towns, 30+ sorting hubs.",
  openGraph: {
    title: "Coverage | PrimeHub Logistics",
