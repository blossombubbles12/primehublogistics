...
export const metadata: Metadata = {  title: "API Docs | PrimeHub Logistics",
  description: "Build with the PrimeHub Logistics API — create shipments, print labels, and stream live tracking events into your platform.",
  openGraph: {
    title: "API Docs | PrimeHub Logistics",
    description: "Developer documentation for the PrimeHub Logistics API.",
    type: "website",
  },
};
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-primary-950 py-24 text-white sm:py-32">
        <div aria-hidden="true" className="absolute inset-0">
          <Image
            src="/gabriel-santos-GBVDilE8yvI-unsplash.jpg"
            alt=""
            fill
            sizes="100vw"
            className="object-cover object-center opacity-20"
