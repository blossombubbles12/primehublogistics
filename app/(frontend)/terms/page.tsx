...
export const metadata: Metadata = {
  title: "Terms of Service | PrimeHub Logistics",
  description: "Review the PrimeHub Logistics terms and conditions that govern the use of our logistics platform, shipping services, and API.",
  openGraph: {
    title: "Terms of Service | PrimeHub Logistics",
    description: "Terms and conditions for using PrimeHub Logistics services.",
    type: "website",
  },
};
...
export default function TermsConditionsPage() {
  return (
    <PolicyPage
      ...
      description="Please read these terms carefully before using the PrimeHub Logistics platform, shipping services, or API."
      ...
      sections={[
        ...
        },
        {
          ...
          body: "PrimeHub Logistics provides logistics and delivery services including: package pickup, transportation, tracking, and delivery across the Netherlands and the UK. We offer multiple service levels (Express, Same-Day, Standard, Economy) with varying speeds, coverage, and pricing. We also provide API access for business integrations.",
        },
        {
        ...
        },
        {
          ...
          body: "All content, trademarks, logos, API, software, and tracking technology are PrimeHub Logistics' property. You may not copy, reverse-engineer, or resell our services without written permission. Business customers may display 'Powered by PrimeHub Logistics' badge per brand guidelines.",
        },
        {
        ...
        },
        {
          ...
          items: [
            "Email: legal@primehublogistics.com",
