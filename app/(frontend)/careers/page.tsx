...
export const metadata: Metadata = {
  title: "Careers | PrimeHub Logistics",
  description: "Join PrimeHub Logistics — Europe's modern logistics technology platform. We're hiring engineers, operators, sales, and support to build the future of delivery.",
  openGraph: {
    title: "Careers | PrimeHub Logistics",
...
const benefits = [
  ...
  "Free PrimeHub Logistics shipments for personal use",
];
    ...
    <>
      ...
      <Section background="muted" spacing="lg" pattern="dots">
        <div className="grid grid-cols-1 gap-14 lg:grid-cols-2 lg:gap-20">
          <Reveal>
            <h2 className="text-section-heading text-foreground">Why PrimeHub Logistics?</h2>
