...
export const metadata: Metadata = {
  title: "Get a Quote | PrimeHub Logistics",
  description: "Get an instant shipping quote from PrimeHub Logistics. Transparent pricing across the Netherlands and the UK — no hidden fees.",
  openGraph: {
    title: "Get a Quote | PrimeHub Logistics",
