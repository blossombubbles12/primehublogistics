...
export const metadata: Metadata = {
  title: "Track Your Shipment | PrimeHub Logistics",
  description: "Track your PrimeHub Logistics shipment in real time. Enter your tracking number for live status updates, milestone history, and estimated delivery.",
  openGraph: {
    title: "Track Your Shipment | PrimeHub Logistics",
          ...
          {!tn && (
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-4 text-caption text-muted-foreground">
                Your tracking number looks like <span className="font-mono">PH-2026-000001</span>. Find it in your
