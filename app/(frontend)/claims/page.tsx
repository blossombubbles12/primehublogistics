...
export const metadata: Metadata = {  title: "Claims | PrimeHub Logistics",
  description: "File a claim for a damaged, lost or delayed shipment with PrimeHub Logistics. Find out what's covered, the limits and how to get reimbursed.",
  openGraph: {
    title: "Claims | PrimeHub Logistics",
