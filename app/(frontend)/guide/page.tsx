...
export const metadata: Metadata = {  title: "Shipping Guide | PrimeHub Logistics",
  description: "Everything you need to ship with PrimeHub Logistics — booking, packaging, labels, tracking and what you can and can't send.",
  openGraph: {
