...
export const metadata: Metadata = {
  title: "Refund & Claims Policy | PrimeHub Logistics",
  description: "Learn about PrimeHub Logistics' refund policy for shipping services, damage claims, lost packages, and service guarantees.",
  openGraph: {
    title: "Refund & Claims Policy | PrimeHub Logistics",
      ...
      sections={[
        ...
        },
        {
          ...
          items: [
            ...
            "Email: claims@primehublogistics.com with tracking number, photos, description",
        ...
        },
        {
          ...
          items: [
            "Tracking number (PH-EU-XXXXXXXX)",
        ...
        },
        {
          ...
          items: [
            "Email: claims@primehublogistics.com",
