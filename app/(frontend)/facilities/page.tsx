...
export const metadata: Metadata = {
  title: "Our Network | PrimeHub Logistics",
  description: "Explore PrimeHub Logistics' delivery network: 30+ sorting hubs, 500+ delivery cities, and advanced tracking infrastructure across the Netherlands and the UK.",
  openGraph: {
    title: "Our Network | PrimeHub Logistics",
