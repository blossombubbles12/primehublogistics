...
export const metadata: Metadata = {
  title: "About Us | PrimeHub Logistics",
  description: "PrimeHub Logistics is Europe's modern logistics technology platform. We make shipping simple, transparent, and reliable with real-time tracking, instant quotes, and coverage across the Netherlands and the UK.",
  openGraph: {
    title: "About Us | PrimeHub Logistics",
    ...
    <>
      ...
      <section className="relative isolate overflow-hidden bg-primary">
        ...
        <div className="absolute inset-0 -z-10">
          <Image
            src="/jacques-dillies-jcav1COVvOc-un.jpg"
            alt="PrimeHub Logistics operations"
            fill
            priority
            sizes="100vw"
        ...
        <Container className="relative flex min-h-[70vh] items-center py-20 sm:py-28 lg:py-32">
          <Reveal className="mx-auto max-w-3xl text-center">
            ...
            <p className="text-body mt-6 max-w-xl mx-auto text-lg text-white/80">
              PrimeHub Logistics was founded on a simple belief: shipping in Europe should be as easy as sending a message. 
          ...
          <Reveal delay={100} className="mt-14">
            <div className="grid gap-8 lg:grid-cols-2 items-center">
              <div className="space-y-6">
                ...
                <p className="text-body">
                  So they built PrimeHub Logistics: a logistics platform where every shipment is tracked in real-time, 
              ...
              <div className="relative">
                <div className="relative aspect-[4/3] rounded-2xl overflow-hidden">
                  <Image
                    src="/venti-views-FPKnAO-CF6M-unsplash.jpg"
                    alt="PrimeHub Logistics delivery network"
                    fill
                    priority
        ...
        <Container>
          <Reveal className="text-center">
            <SectionHeading
              ...
              description="Key moments that shaped PrimeHub Logistics into Europe's leading logistics technology platform."
            />
          </Reveal>
      ...
      <section className="relative isolate overflow-hidden bg-primary text-white">
        ...
        <div className="absolute inset-0 -z-10">
          <Image
            src="/bernd-dittrich-eCc7FjMoR74-unsplash.jpg"
            alt="PrimeHub Logistics network and facilities"
            fill
            priority
            sizes="100vw"
            className="object-cover object-center"
