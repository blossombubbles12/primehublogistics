...
export const metadata: Metadata = {
  title: "Shipping Guide | PrimeHub Logistics",
  description: "Complete guide to shipping with PrimeHub Logistics: packaging, labeling, prohibited items, pickup, delivery, and best practices.",
  openGraph: {
    title: "Shipping Guide | PrimeHub Logistics",
    description: "Everything you need to know to ship successfully with PrimeHub Logistics.",
    type: "website",
  },
};
...
export default function ShippingGuidePage() {
  return (
    <PolicyPage
      ...
      description="Everything you need to know to ship successfully with PrimeHub Logistics — from packaging to delivery."
      ...
      sections={[
        ...
        },
        {
          ...
          body: "These items cannot be shipped via PrimeHub Logistics:",
          items: [
