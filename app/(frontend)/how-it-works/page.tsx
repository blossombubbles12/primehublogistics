...
export const metadata: Metadata = {
  title: "How It Works | PrimeHub Logistics",
  description: "Learn how PrimeHub Logistics makes shipping simple: enter details, schedule pickup, track in real-time, and get proof of delivery. Four steps to delivered.",
  openGraph: {
    title: "How It Works | PrimeHub Logistics",
        ...
        <Container>
          <Reveal>
            <div className="mx-auto max-w-3xl text-center mb-16">
              <h2 className="text-section-heading text-foreground">Why choose PrimeHub Logistics?</h2>
      ...
      <Section background="primary" spacing="lg" pattern="band" className="text-white">
        <Container>
          <Reveal className="mx-auto max-w-3xl text-center">
            ...
            <p className="text-body mt-4 text-white/80">Join thousands of Europeans who trust PrimeHub Logistics for fast, reliable, and transparent delivery.</p>
            <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
