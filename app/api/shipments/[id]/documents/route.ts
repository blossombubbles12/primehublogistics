...
<div class="sheet">
  ...
  <div class="footer">
    <strong style="color:${NAVY};">PrimeHub Logistics</strong> — Courier &amp; Logistics · Amsterdam, Netherlands<br/>
    contact@primehublogistics.com · This invoice was generated automatically for shipment ${tn}.
  </div>
</div>
...
<div class="sheet">
  ...
  <div class="footer">
    <strong style="color:${NAVY};">PrimeHub Logistics</strong> — Courier &amp; Logistics · contact@primehublogistics.com · ${tn}
  </div>
</div>
</body></html>`;
}
...
export async function GET(
  ...
  try {
    ...
    const logoUrl =
      ...
      "/primehub-logo.svg";
    const siteName = settingsAny.siteName ?? "PrimeHub Logistics";
