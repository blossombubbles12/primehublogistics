...
export const metadata = {
  title: "Shipments | PrimeHub Logistics Ops",
  description: "PrimeHub Logistics operations dashboard — manage and track shipments.",
};
    ...
    <div className="flex min-h-screen flex-col bg-slate-50">
      <header className="sticky top-0 z-20 border-b border-slate-200 bg-white/90 backdrop-blur-sm">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          <Link href="/ops/shipments" className="flex items-center gap-2 font-semibold text-slate-900">
            ...
            PrimeHub Logistics <span className="rounded-full bg-slate-100 px-2 py-0.5 text-xs font-medium text-slate-500">Ops</span>
          </Link>
      ...
      <footer className="border-t border-slate-200 bg-white">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 text-xs text-slate-400 sm:px-6 lg:px-8">
          <span>PrimeHub Logistics Operations</span>
